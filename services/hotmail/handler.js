...
const messages = [
  { id: 'hotmail-1', content: 'hii from hotmail!', from: 'tincho', to: 'card-2', createdAt: new Date() },
  { id: 'hotmail-2', content: 'how are you from hotmail?', from: 'tincho', to: 'card-2', createdAt: new Date() }
];
let messageIdx = 2;
  ...
  resolvers: {
    ...
    Mutation: {
      sendMessage(obj, { content, to }) {
        messageIdx++;
        const message = { id: `hotmail-${messageIdx}`, content, from: 'tincho', to, createdAt: new Date() };
